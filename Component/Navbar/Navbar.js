        ...
        <div class="container-fluid">
          <a class="navbar-brand" href="/">
           <div style={{ height: '70px' }}>
                ...
                <p style={{ fontSize: '30px', textAlign: 'center',paddingLeft: '30px' }}> <span style={{ color: 'blue' }}><FontAwesomeIcon icon={faFeatherAlt} />
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-lg-auto mb-lg-2 mb-lg-0">
              ...
              <li class="nav-item ">
                <a class="nav-link active" aria-current="page" href="./company/nayeem">
