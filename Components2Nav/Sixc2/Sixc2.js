...
const Sixc2 = () => {
  ...
  return (
     ...
     <div className="fullform mt-5 pt-5">
      <h2 className="text-center"><span style={{color:"purple"}}>Contact</span> Us</h2>
      <div className="row">
        <div className="d-flex justify-content-end col-sm-12 col-md-6 col-lg-6  ">
          <img className="pb-5 " src={img} style={{ height: "400px", width: "400px" }} alt="" />
        </div>
        ...
        <div className="col-sm-12 col-md-6 col-lg-6">
          <div className="firstForm">
            ...
            <form onSubmit={sendEmail}>
              ...
              <label >Number</label>
              <input type="number" placeholder="01756432****" name="number" required/>
