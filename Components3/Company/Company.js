      ...
      <Drawer 
        ...
        <Link to="/company/nayeem" className={classes.link}>
              <ListItem button>
                ...
                <ListItemText className='fst-italic' primary={"Company"} style={{color:"#260f33"}} />
              </ListItem>
            </Link>
            ...
            <Link to="/jobpost" className={classes.link}>
              <ListItem button>
                ...
                <ListItemText className='fst-italic' primary={"JobPost"} style={{color:"#0f24a8"}} />
              </ListItem>
            </Link>
            <Link to="/deletecv" className={classes.link}>
              <ListItem button>
                ...
                <ListItemText className='fst-italic' primary={"DeleteCV"} style={{color:"#0f24a8",fontFamily: 'Roboto Slab'}}/>
              </ListItem>
            </Link>
            ...
            <Link to="/showcv" className={classes.link}>
              <ListItem button>
                ...
                <ListItemText className='fst-italic' primary={"Show CV"} style={{color:"#0f24a8"}}/>
              </ListItem>
            </Link>
             <Link to="/approve" className={classes.link}>
              <ListItem button>
                ...
                <ListItemText className='fst-italic' primary={"Approve CV"} style={{color:"#0f24a8"}}/>
              </ListItem>
            </Link>
            ...
            <Link to="/aproveList" className={classes.link}>
              <ListItem button>
                ...
                <ListItemText className='fst-italic' primary={"Approve Success"} style={{color:"#0f24a8"}}/>
              </ListItem>
            </Link>
            ...
            <Link to="/loggedout" className={classes.link}>
              <ListItem button>
                ...
                <ListItemText className='fst-italic' primary={"Logged Out"} style={{color:"#0f24a8" }}/>
              </ListItem>
            </Link>
          ...
          <div>
            ...
            <h1   style={{color:'#5e2201'}}>You have no permission to access Company page so <span style={{color:'red'}}>back Homepage</span></h1>

          
          
             <br />

          <button style={{backgroundColor:'#856984'}} className= 'btn ps-5 ms-3' onClick={logout2}><FontAwesomeIcon icon={faArrowLeft} /> back Homepage</button>
